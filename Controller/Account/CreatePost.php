...
namespace Tezus\UnicTaxvat\Controller\Account;
...
use Tezus\UnicTaxvat\Model\Api\Validation;
...
class CreatePost extends \Magento\Customer\Controller\Account\CreatePost
{
     ...
     * @var Validation
     */
    private Validation $_taxvatValidation;
     ...
     * @param Validation $taxvatValidation
    ...
    public function __construct(
        ...
        Validation $taxvatValidation
    ) {
        $this->accountRedirect = $accountRedirect;
        $this->formKeyValidator = $formKeyValidator;
        $this->_taxvatValidation = $taxvatValidation;
        parent::__construct(
            $context,
            $customerSession,
            $scopeConfig,
    ...
    public function execute()
    {
        ...
        try {
            ...
            /* Taxvat validation */
            $validTaxvat = $this->_taxvatValidation->validateTaxvat($customer->getTaxvat());
            if (!$validTaxvat) {
                throw new StateException(__("Customer taxvat already exists in database"));
            }
            /* /Taxvat validation */
